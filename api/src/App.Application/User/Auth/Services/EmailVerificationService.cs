...
{
  Task<ErrorOr<Success>> SendVerificationEmailAsync(UserDomain user, CancellationToken cancellationToken = default);
}
...
public class EmailVerificationService : IEmailVerificationService
{
  ...
  public async Task<ErrorOr<Success>> SendVerificationEmailAsync(UserDomain user, CancellationToken cancellationToken = default)
  {
